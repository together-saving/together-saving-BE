...
import com.savle.togethersaving.config.exception.DuplicatedWishException;
...
public class WishService {
    ...
    public Wish addWish(Long userId, Long challengeId) {
        if (isWished(challengeRepository.getById(challengeId), userId)) {
            throw new DuplicatedWishException("Duplicated Wish. user-id :" + userId + ", challenge-id : " + challengeId);
        }
